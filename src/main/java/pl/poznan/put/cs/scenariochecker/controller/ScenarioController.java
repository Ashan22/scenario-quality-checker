...
public class ScenarioController {
    ...
    @PostMapping("/scenarios/levels/{level}")
    public String returnSubScenarios(@RequestBody Scenario scenario, @PathVariable String level) {
        scenario.setLevel(Integer.valueOf(level));
